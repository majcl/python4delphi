"""Tests for the main DelphiRTTI API: get_type_rtti and wrapped RTTI types (methods, properties)."""
import pytest
...
class TestEdgeCases:
    def test_invalid_argument(self, rtti_module):
        # Debug build raises TypeError (EDelphiRTTIInvalidArgument); Release may raise RuntimeError
